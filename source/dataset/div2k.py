...
if __name__ == '__main__':
    HR_folder = '/dataset/SR2/DIV2K/DIV2K_train_HR'
    LR_folder = '/dataset/SR2/DIV2K/DIV2K_train_LR_bicubic'
    argment   = True
    div2k = DIV2K(HR_folder, LR_folder, train=True, augment=True, scale=3, colors=3, patch_size=96, repeat=168, store_in_ram=False)
