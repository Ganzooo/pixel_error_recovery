...
def ndarray2tensorTEST(ndarray_hwc):
...
if __name__ == '__main__':
    # HR_folder = '/dataset/SR2/benchmark/B100/HR'
    # LR_folder = '/dataset/SR2/benchmark/B100/LR_bicubic'
    # HR_folder = '/dataset/SR2/benchmark/Set14/HR'
    # LR_folder = '/dataset/SR2/benchmark/Set14/LR_bicubic'
    # HR_folder = '/dataset/SR2/benchmark/Set5/HR'
    # LR_folder = '/dataset/SR2/benchmark/Set5/LR_bicubic'
    HR_folder = '/dataset/SR2/benchmark/Urban100/HR'
    LR_folder = '/dataset/SR2/benchmark/Urban100/LR_bicubic'
    benchmark = Benchmark(HR_folder, LR_folder, scale=3, colors=3, store_in_ram=False)
