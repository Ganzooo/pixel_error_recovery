...
#python test.py --multirun hydra.sweep.dir=test/avtivation hydra.sweep.subdir='relu' model.activation='relu' train_config.testmodelpath=/workspace/pixel_error_recovery/models/base_last_epoch.pt # base model
...
python test.py --multirun hydra.sweep.dir=test/ps hydra.sweep.subdir=factor2 model.ps_scale=2 train_config.testmodelpath=/workspace/pixel_error_recovery/models/ps_factor2_last_epoch.pt
python test.py --multirun hydra.sweep.dir=test/ps hydra.sweep.subdir=factor4 model.ps_scale=4 train_config.testmodelpath=/workspace/pixel_error_recovery/models/ps_factor4_last_epoch.pt
python test.py --multirun hydra.sweep.dir=test/ps hydra.sweep.subdir=factor8 model.ps_scale=8 train_config.testmodelpath=/workspace/pixel_error_recovery/models/ps_factor8_last_epoch.pt
